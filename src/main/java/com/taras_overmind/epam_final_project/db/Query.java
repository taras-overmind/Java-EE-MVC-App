...
public class Query {
    ...
    public static final String SELECT_COURSES_TO_REGISTER = "SELECT COURSES.id_course, COURSES.duration, THEMES.name_theme, LECTURERS.surname, LECTURERS.name, LECTURERS.patronymic \n" +
            "FROM COURSES \n" +
